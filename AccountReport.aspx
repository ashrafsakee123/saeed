<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountReport.aspx.cs" Inherits="SAEED.WebPL.AccountReport" %>
...
تقرير رسوم المعاملات                                         <span class="tools pull-left">
         ...
         <div class="col-sm-12">
             <div class="col-md-3 form-group"  >
                 ...
                 <asp:DropDownList ID="DropDownListBy" runat="server" CssClass="form-control" style="padding:0px">
                     <asp:ListItem Value="1" Text="تاريخ الفاتورة" Selected="True" ></asp:ListItem>
                                          <asp:ListItem Value="2" Text="تاريخ الدفع" ></asp:ListItem>
     ...
     <div class="col-md-3 form-group">
      ...
      <div class="col-md-3 form-group" style="vertical-align:bottom; padding-top:25px">
        ...
        <center>
            ...
            <LocalReport ReportPath="Reports\AccountReport.rdlc">
