<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="CompletedTransactions.aspx.cs" Inherits="SAEED.WebPL.CompletedTransactions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row">
        ...
        <div class="col-sm-12">
                                    ...
                                    <asp:Repeater ID="RepeaterIns" ClientIDMode="Static" runat="server">
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                ...
                                                <td><%# Eval("TDate") %></td>
                                                <td><%# Eval("Amount") %></td>
                                                <td><span class="label label-<%#(Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.بالانتظار ||Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.مرفوضة )? "danger" : (Convert.ToInt32(Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.مخصصة ||Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.جاهزة_للتخليص_الخارجي) ? "warning" : ( Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.بالتنفيذ|| Convert.ToInt32(  Eval("StatusID"))==(int)SAEED.BLL.TransactionStatusList.بالتخليص_الخارجي )?"inverse":( Convert.ToInt32( Eval("StatusID"))==(int)SAEED.BLL.TransactionStatusList.جاهزة_للاستلام  || Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.مؤرشفة)?"info": Convert.ToInt32( Eval("StatusID"))==(int)SAEED.BLL.TransactionStatusList.ملغية?"default":"success"%> label-mini"><%# Eval("Status").ToString() %></span></td>
                                                <td>
         ...
         <asp:Timer ID="Timer1" Interval="120000" runat="server" OnTick="Timer1_Tick"></asp:Timer>
                        </ContentTemplate>
