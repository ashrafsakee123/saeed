<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpCountReport.aspx.cs" Inherits="SAEED.WebPL.EmpCountReport"  %>
...
تقرير عدد المعاملات                                         <span class="tools pull-left">
     ...
     <div class="col-md-3 form-group">
      ...
      <div class="col-md-3 form-group" style="vertical-align:bottom; padding-top:25px">
        ...
        <center>
            ...
            <LocalReport ReportPath="Reports\EmpCountReport.rdlc">
