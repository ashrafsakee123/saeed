<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpFeesReport.aspx.cs" Inherits="SAEED.WebPL.EmpFeesReport"  %>
...
تقرير الرسوم الحكومية                                         <span class="tools pull-left">
     ...
     <div class="col-md-3 form-group">
      ...
      <div class="col-md-3 form-group" style="vertical-align:bottom; padding-top:25px">
        ...
        <center>
            ...
            <LocalReport ReportPath="Reports\EmpFeesReport.rdlc">
