<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IncomeReport.aspx.cs" Inherits="SAEED.WebPL.IncomeReport"  %>
...
تقرير ربح المركز                                         <span class="tools pull-left">
     ...
     <div class="col-md-3 form-group">
      ...
      <div class="col-md-3 form-group" style="vertical-align:bottom; padding-top:25px">
        ...
        <center>
            ...
            <LocalReport ReportPath="Reports\IncomeReport.rdlc">
