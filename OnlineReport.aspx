<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineReport.aspx.cs" Inherits="SAEED.WebPL.OnlineReport"  %>
...
تقرير معاملات البلدية الأونلين                                         <span class="tools pull-left">
     ...
     <div class="col-md-3 form-group">
      ...
      <div class="col-md-3 form-group" style="vertical-align:bottom; padding-top:25px">
        ...
        <center>
            ...
            <LocalReport ReportPath="Reports\OnlineReport.rdlc">
