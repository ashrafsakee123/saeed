<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="TransactionsList.aspx.cs" Inherits="SAEED.WebPL.TransactionsList" %>
        ...
        <div class="col-sm-12">
            <section class="panel" style="padding: 5px">
                ...
                <div class="panel-body">
                    ...
                    <asp:Button ID="ButtonReport" runat="server" Text="طباعة تقرير" CssClass="btn btn-default " OnClick="ButtonReport_Click" />
                    <asp:Button ID="ButtonAll" runat="server" Text="الغاء التصفية" CssClass="btn btn-white " OnClick="ButtonAll_Click" />


                    <asp:UpdatePanel ID="UpdatePanelTrans" ClientIDMode="Static" runat="server" UpdateMode="Conditional">
                        <Triggers>
                        ...
                        <ContentTemplate>
                                    ...
                                    <asp:Repeater ID="RepeaterIns" ClientIDMode="Static" runat="server">
                                        <ItemTemplate>
                                            <tr class="gradeA">
                                                ...
                                                <td><%# Eval("TDate") %></td>
                                                <td><%# Eval("Amount") %></td>
                                                 <td><%# Eval("HappyFactor") %></td>
                                                 <td><%# Eval("Loyalty") %></td>
                                                <td><span class="label label-<%#(Convert.ToInt32(Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.بالانتظار || Convert.ToInt32(Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.مرفوضة) ? "danger" : (Convert.ToInt32(Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.مخصصة || Convert.ToInt32(Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.جاهزة_للتخليص_الخارجي|| Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.للتعديل ||Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.جاهزة_للتخليص_الخارجي) ? "warning" : ( Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.بالتنفيذ|| Convert.ToInt32(  Eval("StatusID"))==(int)SAEED.BLL.TransactionStatusList.بالتخليص_الخارجي )?"inverse":( Convert.ToInt32( Eval("StatusID"))==(int)SAEED.BLL.TransactionStatusList.جاهزة_للاستلام  || Convert.ToInt32( Eval("StatusID")) == (int)SAEED.BLL.TransactionStatusList.مؤرشفة)?"info": Convert.ToInt32( Eval("StatusID"))==(int)SAEED.BLL.TransactionStatusList.ملغية?"default":"success"%> label-mini"><%# Eval("Status").ToString() %></span></td>
                                                <td>
                                                    <%if ((SAEED.BLL.AccessRoleList)Session["role"] == SAEED.BLL.AccessRoleList.مدخل_بيانات)
                                                        {%>
                                                    <a class="btn btn-warning btn-xs" href="ViewTransaction.aspx?id=<%#  Eval("ID").ToString() %>"><i class="fa fa-edit"></i>إجراء </a>
                                                    <%} %>

                                                    <%if ((SAEED.BLL.AccessRoleList)Session["role"] == SAEED.BLL.AccessRoleList.مدير_المركز)
                                                        {%>
                                                    <a class="btn btn-info btn-xs" href="ViewTransaction.aspx?id=<%#  Eval("ID").ToString() %>"><i class="fa fa-eye "></i>عرض </a>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a class="btn btn-danger" href="DeleteTransaction.aspx?id=<%# Eval( "ID") %>">حذف</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <asp:Timer ID="Timer1" Interval="30000" runat="server" OnTick="Timer1_Tick"></asp:Timer>
                        </ContentTemplate>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow-y: scroll; height: 45em; overflow-x: hidden">
                    <div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                     ...
                     <div class="col-sm-12">
                        ...
                        <div class="col-md-4 form-group">
                            <asp:TextBox ID="TextBoxComDateFrom" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            <asp:TextBox ID="TextBoxComDateTo" CssClass="form-control" TextMode="Date" runat="server"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="col-md-2 form-group">
                    ...
                    <div class="col-sm-12">
                      ...
                      <div class="col-sm-12">
                        ...
                        <div class="col-md-4 form-group">
 <asp:DropDownList runat="server" ID="DropDownListHappy" CssClass="form-control m-bot15" Style="padding: 0px">
                        ...
                        <div class="col-md-4 form-group">
 <asp:DropDownList runat="server" ID="DropDownListLoyalty" CssClass="form-control m-bot15" Style="padding: 0px">
                            </asp:DropDownList>                        </div>
                      ...
                      <div class="col-md-2 form-group">
                        ...
                        <div class="col-md-4 form-group">
                            <asp:TextBox ID="TextBoxSales" CssClass="form-control"  runat="server"></asp:TextBox>
